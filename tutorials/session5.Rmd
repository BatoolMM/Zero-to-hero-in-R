...
{: .callout}
> download.file("https://ndownloader.figshare.com/files/11492171","data/SAFI_clean.csv", mode = "wb"), if you don't have the data
...
## look into th working directory
...
## How to select one column and get the unque value
...
```{r}
#What is the unique value inrespondent_wall_type?
...
# to do the same thing with subtracting

small_data <- select(interviews,-c(village, rooms))
